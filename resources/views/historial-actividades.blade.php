    ...
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card shadow">
                ...
                <div class="card-body">
                    <form action="{{ route('historial-actividades') }}" method="get" class="mb-4">
                        <div class="form-row">
                            <div class="col-md-4 mb-2">
                                <input type="text" class="form-control" name="searchUser" placeholder="Buscar por usuario" value="{{ request('searchUser') }}">
                            </div>
                            <div class="col-md-4 mb-2">
                                <input type="text" class="form-control" name="searchDNI" placeholder="Buscar por número de DNI" value="{{ request('searchDNI') }}">
                            </div>
                            <div class="col-md-4 mb-2">
                            ...
                            <div class="col-md-12 text-center">
                                ...
                                <a href="{{ route('historial-actividades') }}" class="btn btn-secondary">Limpiar</a>
                            </div>
                        </div>
                    </form>
