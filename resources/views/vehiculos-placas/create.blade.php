...
<div class="container mt-5">
    ...
    <form action="{{ route('guardar_vehiculo') }}" method="POST">
        @csrf
        ...
        <div class="row mb-3">
            ...
            <div class="col-lg-9">
                <input type="text" name="Tipo_Porcentaje" class="form-control" required>
            </div>
        </div>
        ...
        <div class="row mb-3">
            ...
            <div class="col-lg-9">
                <div class="input-group">
                    ...
                    <input type="text" name="Probabilidad" class="form-control" disable>
                </div>
            </div>
        </div>
